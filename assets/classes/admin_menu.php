...
class TERMINFLIX_ADMIN_MENU{
  ...
  function get(){
    ...
    $meta = get_user_meta(get_current_user_id(), 'bookingflix', true);
    if($meta){
  ...
  function get_start(){
    ...
    $start = new TERMINFLIX_START();
    $start->plugin_dir = $this->plugin_dir;
    $start->register_scripts = $this->register_scripts;
    $start->language = $this->language;
    $start->userdata = $this->userdata;
  ...
  function get_signin(){
    ...
    require_once( dirname(__FILE__) . "/sign_in.php" );

    $signin = new TERMINFLIX_SIGN_IN();
    $signin->plugin_dir = $this->plugin_dir;
    $signin->register_scripts = $this->register_scripts;
    $signin->language = $this->language;


   add_submenu_page(

         $this->menu_name,
          __('Connect to Wordpress', 'terminflix'),
          __('Connect to Wordpress', 'terminflix'),
         "edit_posts",
         "signin_".$this->menu_name,
         array($signin, "get")
  ...
  function get_quickstart(){
    ...
    $quickstart->language = $this->language;
     ...
     add_submenu_page(
           ...
           $this->menu_name,
            __('Create first Calendar', 'terminflix'),
            __('Create first Calendar', 'terminflix'),
           "edit_posts",
           "quickstart_".$this->menu_name,
  ...
  function get_dashboard(){
    ...
    add_submenu_page(
          ...
          $this->menu_name,
           __('Dashboard', 'terminflix'),
           __('Dashboard', 'terminflix'),
          "edit_posts",
          "dashboard_".$this->menu_name,
          array($dashboard, "get")
